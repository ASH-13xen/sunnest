...
const ContactPage = memo(function ContactPage({ section }: Props) {
  ...
  return (
    <div
      ...
      className={cn(
        "w-screen h-screen relative overflow-hidden rounded-2xl flex justify-center items-center px-4 md:px-8 py-16 bg-bg-cream",
    ...
    >
      ...
      <div className="w-full max-w-5xl h-full max-h-[80vh] min-h-[500px] glass-outer backdrop-blur-sm border border-[rgba(212,160,23,0.25)] rounded-[2.5rem] shadow-2xl shadow-[#0A1628]/15 overflow-hidden relative z-10 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-[38%] bg-gradient-to-b from-[#0A1628] to-[#0D1F3C] p-8 md:p-10 flex flex-col justify-center relative overflow-hidden shrink-0 border-r border-[#d4a017]/10 z-10 contact-card-sidebar">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full">
              ...
              <div className="space-y-3">
                {CONTACT_ITEMS.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-7.5 h-7.5 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[#FFD700]/40 transition-colors shrink-0">
                        <Icon className="w-3.5 h-3.5 text-[#FFD700]" />
                      </div>
                      <div>
                        <div className="text-[8px] text-white/40 font-bold uppercase tracking-wider">{item.label}</div>
                        <div className="text-[11px] text-white/80 group-hover:text-white transition-colors">{item.value}</div>
                      </div>
                    </a>
                  );
                })}
            ...
            <div className="mt-5">
              {/* Alert Box */}
              <div className="p-3.5 bg-[rgba(212,160,23,0.12)] border border-[rgba(212,160,23,0.2)] rounded-xl">
        ...
        <div className="flex-1 glass-inner backdrop-blur-md relative flex flex-col justify-center p-8 md:p-10 z-0 contact-card-content">
                  ...
                  <div className="flex-1 flex flex-col justify-between min-h-0">
                    ...
                    {bookingStep === 1 && (
                      <div className="flex-1 flex flex-col justify-center min-h-0">
                        ...
                        {/* Calendar Grid */}
                        <div className="grid grid-cols-7 gap-1 mb-4 flex-1 overflow-y-auto no-scrollbar">
                          ...
                          {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => {
                            ...
                            return (
                              <button
                                ...
                                disabled={disabled}
                                className={cn(
                                  "py-1 text-[10.5px] font-bold rounded-lg transition-all duration-200 border-none",
                                  selected
                        ...
                        <button
                          ...
                          className={cn(
                            "w-full flex items-center justify-center py-2 rounded-xl text-[10.5px] font-bold text-white transition-all shadow-md shrink-0 border-none",
                            selectedDay
                      ...
                      <div className="flex-1 flex flex-col justify-center shrink-0">
                        <div className="flex items-center gap-2 mb-3.5">
                          ...
                          <div>
                            ...
                            <p className="text-[9px] text-text-light">{monthName} {selectedDay}, {currentYear}</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-5">
                          {timeSlots.map((time) => (
                            <button
                              ...
                              className={cn(
                                "py-2 px-1 text-[10.5px] font-bold rounded-xl border text-center transition-all duration-200 cursor-pointer",
                                selectedTime === time
                        ...
                        <button
                          ...
                          className={cn(
                            "w-full flex items-center justify-center py-2 rounded-xl text-[10.5px] font-bold text-white transition-all shadow-md border-none",
                            selectedTime
                              ? "bg-gradient-to-r from-[#D4A017] to-[#FFCA28] hover:from-[#B38600] hover:to-[#D4A017] cursor-pointer shadow-[#D4A017]/25"
                              : "bg-slate-300 cursor-not-allowed shadow-none"
                          )}
                    ...
                    {/* Step 3: Details form */}
                    {bookingStep === 3 && (
                      <form onSubmit={handleBookingSubmit} onClick={(e) => e.stopPropagation()} className="flex-1 flex flex-col justify-center space-y-2.5">
                        <div className="flex items-center gap-2 mb-1.5 shrink-0">
                          ...
                          <div>
                            ...
                            <p className="text-[9px] text-text-light">{monthName} {selectedDay} at {selectedTime}</p>
                          </div>
                        </div>

                        <div className="grid grid-cols-2 gap-2.5">
                          <div>
                            <label className="block text-[9px] font-bold text-text-mid mb-0.5">Full Name *</label>
                            <input
                              type="text"
                              required
                              value={bookingForm.name}
                              onChange={(e) => setBookingForm({ ...bookingForm, name: e.target.value })}
                              className="w-full px-3 py-1.5 border border-[#D4A017]/20 rounded-lg text-[11px] text-text-dark bg-white focus:outline-none focus:border-[#D4A017]"
                            />
                          </div>
                          <div>
                            <label className="block text-[9px] font-bold text-text-mid mb-0.5">Email *</label>
                            <input
                              type="email"
                              required
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          <div>
                            <label className="block text-[9px] font-bold text-text-mid mb-0.5">Phone *</label>
                            <input
                              type="tel"
                              required
                          ...
                          <div>
                            <label className="block text-[9px] font-bold text-text-mid mb-0.5">Address *</label>
                            <input
                              type="text"
                              required
                        ...
                        <div>
                          <label className="block text-[9px] font-bold text-text-mid mb-0.5">Additional Notes</label>
                          <textarea
                            value={bookingForm.notes}
                            onChange={(e) => setBookingForm({ ...bookingForm, notes: e.target.value })}
                            rows={1.5}
                            className="w-full px-3 py-1.5 border border-[#D4A017]/20 rounded-lg text-[11px] text-text-dark bg-white focus:outline-none focus:border-[#D4A017] resize-none"
                          />
                        </div>

                        <button
                          type="submit"
                          className="w-full py-2 bg-gradient-to-r from-[#D4A017] to-[#FFCA28] hover:from-[#B38600] hover:to-[#D4A017] text-white rounded-xl text-[10.5px] font-black transition-all shadow-md shadow-[#D4A017]/25 cursor-pointer flex items-center justify-center gap-1 border-none"
                        >
            ...
            {activeTab === "message" && (
              <div className="flex-1 flex flex-col justify-between min-h-0 overflow-y-auto no-scrollbar">
                {querySubmitted ? (
                  ...
                  <form onSubmit={handleQuerySubmit} onClick={(e) => e.stopPropagation()} className="flex-1 flex flex-col justify-center space-y-3">
                    <div className="grid grid-cols-2 gap-2.5">
                      <div>
                        <label className="block text-[9px] font-bold text-text-mid mb-0.5">Full Name *</label>
                        <input
                          ...
                          className="w-full px-3 py-2 border border-[#D4A017]/20 rounded-lg text-[11px] text-text-dark bg-white focus:outline-none focus:border-[#D4A017]"
                        />
                      </div>
                      <div>
                        <label className="block text-[9px] font-bold text-text-mid mb-0.5">Email Address *</label>
                        <input
                          type="email"
                          required
                    ...
                    <div>
                      <label className="block text-[9px] font-bold text-text-mid mb-0.5">Phone Number</label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label className="block text-[9px] font-bold text-text-mid mb-0.5">Tell us about your project *</label>
                      <textarea
                        required
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-[#D4A017]/20 rounded-lg text-[11px] text-text-dark bg-white focus:outline-none focus:border-[#D4A017] resize-none"
                      />
                    </div>

                    <button
                      type="submit"
                      className="w-full py-2.5 bg-gradient-to-r from-[#D4A017] to-[#FFCA28] hover:from-[#B38600] hover:to-[#D4A017] text-white rounded-xl text-[10.5px] font-black transition-all shadow-md shadow-[#D4A017]/25 cursor-pointer flex items-center justify-center gap-1 border-none"
                    >
