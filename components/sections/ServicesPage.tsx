    ...
    >
      ...
      <div className="w-full flex flex-col lg:justify-center lg:items-center pt-20 pb-8 px-4 lg:py-16 lg:pb-12 relative shrink-0">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:h-full lg:max-w-5xl lg:max-h-[80vh] lg:min-h-[500px] lg:glass-outer lg:backdrop-blur-sm lg:border lg:border-gold-500/25 lg:rounded-[2.5rem] lg:shadow-2xl lg:shadow-navy-900/15 lg:overflow-hidden relative z-10">
          ...
          <div className="w-full lg:w-[38%] bg-gradient-to-b from-navy-900 to-navy-800 p-8 lg:p-10 flex flex-col justify-center relative overflow-hidden shrink-0 border-b lg:border-b-0 lg:border-r border-gold-500/10 z-10 rounded-2xl lg:rounded-none">
            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-2.5">
                  ...
                  <span className="font-serif italic font-normal text-gold-400 capitalize normal-case text-[14px] md:text-[15px] tracking-wide">
                ...
                <h1 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3">
                  {activeTab === "process" ? (
                    <>
                      Our<br />
                      <span className="bg-linear-to-r from-gold-500 via-gold-400 to-gold-600 bg-clip-text text-transparent">Process</span>
                    </>
                  ) : (
                    <>
                      Common<br />
                      <span className="bg-linear-to-r from-gold-500 via-gold-400 to-gold-600 bg-clip-text text-transparent">Questions</span>
                    </>
                  )}
                </h1>
                ...
                <div className="space-y-1 mb-4">
                  {(activeTab === "process"
                    ...
                    <p key={line} className="text-[11px] font-bold text-gold-400">{line}</p>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <button
                  ...
                  className="self-start px-4.5 py-2 bg-gradient-to-r from-gold-500 to-gold-400 text-navy-900 rounded-xl text-[10.5px] font-black hover:from-gold-600 hover:to-gold-500 transition-all shadow-lg shadow-gold-500/20 cursor-pointer border-none"
                >
              ...
              {activeTab === "process" && (
                <div className="flex-1 flex flex-col min-h-0">
                  <div className="text-center mb-3 shrink-0">
                    <span className="font-serif italic font-normal text-gold-500 capitalize normal-case text-[13px] md:text-[15px] mb-0.5 block tracking-wide">
                      Step-by-step
                    </span>
                        ...
                        return (
                          <div key={step.num} className="flex gap-2.5 items-start">
                            <div className="flex flex-col items-center shrink-0">
                              ...
                              {i < STEPS.length - 1 && (
                                <div className="w-px h-2 bg-gold-400/40 mt-0.5" />
                              )}
                            </div>

                            <div className="flex-1 glass-card-sm border border-gold-500/20 rounded-xl px-3.5 py-2 -mt-0.5 shadow-sm">
                              <span className="font-serif italic font-normal text-gold-500 text-[10.5px] lg:text-[12px] tracking-wide block mb-0.5">
                                Step {step.num}
                              </span>
              ...
              {activeTab === "faq" && (
                <div className="flex-1 flex flex-col justify-between min-h-0">
                  <div className="text-center mb-4 shrink-0">
                    <span className="text-[10px] font-black uppercase tracking-widest text-gold-500 mb-1 block">
                      Support FAQs
                    </span>
                    <h2 className="text-lg md:text-xl font-black text-text-dark tracking-tight">
